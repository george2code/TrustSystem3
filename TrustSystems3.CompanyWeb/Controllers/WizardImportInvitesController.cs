...
{
    [Authorize]
    public class WizardImportInvitesController : BaseController
    {
        private AfsRepository _afsRepository;
        private InvitationRepository _invitationRepository;

        public WizardImportInvitesController()
        {
        ...
        {
            if (Session["invite_info_import"] == null)
            {
                Session["invite_info_import"] = new InviteInfo();
            }
            return (InviteInfo)Session["invite_info_import"];
        }

        private void RemoveInviteInfo()
        {
            Session.Remove("invite_info_import");
        }
