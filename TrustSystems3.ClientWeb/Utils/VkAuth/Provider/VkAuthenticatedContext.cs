...
namespace TrustSystems3.ClientWeb.Utils.VkAuth.Provider
{
    ...
    public class VkAuthenticatedContext : BaseContext
    {
            ...
            : base(context)
        {
            ...
            Sex = TryGetValue("sex");
            Bdate = TryGetValue("bdate");
            Avatar = TryGetValue("photo_medium");
        ...
        /// <summary>
        /// Gets the user's profile big picture link
        /// </summary>
        public string Avatar { get; private set; }

        /// <summary>
        /// Gets the user's sex: 1 - female, 2 - male
        /// </summary>
        public string Sex { get; private set; }

        /// <summary>
        /// Gets the user's birthdate 15.2 format
        /// </summary>
